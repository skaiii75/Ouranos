...
export const BucketSelector = ({ buckets, isLoading, error, onSelectBucket }: BucketSelectorProps) => {
        ...
        <div class="selector-list">
          <ul>
            ${buckets.map(bucket => html`
              <li key=${bucket} onClick=${() => onSelectBucket(bucket)} role="button" tabindex="0">
